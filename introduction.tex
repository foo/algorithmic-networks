...
Optimization of this resource is critical for performing efficient large-scale computations, as those involve multiple machines that cooperate over the network.
...
by another equivalent and a smaller set. Optimal aggregation of a fixed routing
