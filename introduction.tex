...
We consider a variant of virtual network embedding with extensions motivatied by batch-processing applications.
...
an $O(\!\sqrt{\log n \cdot \log \ell})$-approximation algorithm~\cite{KrNaSc09}.
