...
We study the data-locality and replica aware virtual network embedding problems in datacenters\todo{To zdanie jest niejasne}.
...
\todo{scal po zdefiniowaniu modelu}
...
\todo{Szkic paragrafu: Powyzej opisalem modele bez zaleznosci. Modele z zaleznosciami. Modele powstale z praktycznych motywacji fib: FIB caching, FIB aggregation -- wybierz ktore prace zacytowac. }
