...
This led to a shift of computations to large-scale remote facilities that contain computer clusters with their support infrastructure, the so-called \emph{data centers}.
