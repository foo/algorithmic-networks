\todo{Annotation: parts of this paper are shared with Carlo's thesis!}


\section{Model}\label{sec:model}

\todo{Embed reference in the right place}
...
\subsection{Hardness of Multi-Assignments ($\FP+\RS+\MA$)}\label{ssec:fprsma}
...
\subsection{Hardness of Inter-connects ($\FP+\RS+\CC$)}\label{ssec:fprscc}
