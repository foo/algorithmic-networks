...
First, we lower-bound the cost incurred by $n_1$ and $n_2$.
In total, $n_1$ and $n_2$ process $2\cdot \MaFactor = 6$ chunks.
...
Remaining $3$ chunks that $n_1$ and $n_2$ process reside outside of this triple gadget and incur the cost $3 \cdot 4$.
...
In total, $n_1$ and $n_2$ incur a cost at least $14$, and the total cost $4\cdot k + 6$ exceeds the threshold $\Thr = 4\cdot k$.
