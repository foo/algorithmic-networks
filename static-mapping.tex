...
\begin{enumerate}
  ...
  \item {\ElGadget} for element $e$ consists of the
...
Concretely, we construct the following chunks:
\begin{enumerate}
...
$\Band(\sum_e (\deg(e)-1)$.
Note that out of $\deg(e)$ leaves of \ElGadget{} for element $e$, we allow to place $\deg(e)-1$ nodes.
