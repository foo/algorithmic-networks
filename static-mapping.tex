...
The constructions are based upon the reduction of $\TDPM$ to the $\FP+\RS+\MA$ variant of the $\CTE$ problem (see Section~\ref{ssec:fprsma}) and the reduction of $\TDPM$ to the $\FP+\RS+\NI$ variant (see Section~\ref{ssec:fprscc}).
