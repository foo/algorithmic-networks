...
In the lemmas below, we show that in feasible solutions to $\ICTE$, exactly $k$ \TripleGadgets{} are active (similarly to Theorem~\ref{th:ma-unlimited}).
...
\begin{proof}
  ...
  Now, we show that $\STDPM$ is feasible, i.e., it matches every element of $X\cup Y\cup Z$ exactly once, and the matching is composed from the set of triples $P$.
