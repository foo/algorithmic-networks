...
Our goal is to show that in every feasible solution, exactly $k$ \TripleGadgets{} are active, and triples that correspond to active \TripleGadgets{} in $\SVCEMB$ are the feasible solution to $\ITDPM$.
