...
\subsection{Mult-Assignment with at Most Two Replicas}
...
\item The capacity of each server is set to $1$.
...
we can exploit Lemma~\ref{lemma:helper} to construct a solution for~$\ITDPM$: in any solution of cost at most~$\Thr$,
