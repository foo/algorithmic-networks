In large-scale batch-processing systems (e.g. those using MapReduce computing paradigm~\cite{mapreduce}), multiple machines cooperate to processes large quantities of data stored in the data center in a distributed manner.
...
In this chapter, we consider all possible variants, where each of these five aspects
