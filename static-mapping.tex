...
Since all chunks are matched to exactly one node, every element of~$X$,~$Y$ and~$Z$ is matched, and $\STDPM$ form a 3-dimensional perfect matching of $X \cup Y\cup Z$.
\end{proof}
...
We construct the substrate network that consists of two subtrees connected to the
  ...
  The contruction is depicted in Figure~\ref{fig:red-ma2}. Gadgets are constructed in the following way.
\begin{figure}[t]
  \centering
