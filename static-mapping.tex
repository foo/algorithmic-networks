...
We define the footprint of a virtual cluster as follows
$$
...
%\end{figure}
This section presents two algorithms to solve 
two variants of the $\CTE$ problem, $\RS+\MA+\NI$ and~$\MA+\NI+\BW$, that can also be solved with the flow approach
introduced above.
...
Given the~$\MA$ variant of the $\CTE$ problem and a proper subtree~$\Tree'$
containing~$\tau(T')$
