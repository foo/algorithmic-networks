...
\todo{czy wprowadzam transport cost?}
...
\parag{Construction of Artificial Graph.}
...
\parag{Example.} Figure~\ref{fig:flow_construction} shows an example of the extended substrate
...
\begin{figure}
\centering
\includegraphics[width=0.4\columnwidth]{figs/static-mapping/flow_ma_cv}
...
\parag{Example.} Before analyzing our algorithm, let us consider a small example.
