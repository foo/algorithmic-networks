% Once accepted, we have to review manual of style at 
% https://www.siam.org/journals/auth-info.php once again.
...
\newcommand{\chen}[1]{\marginnote{\textcolor{red}{Chen: #1}}}

\numberwithin{theorem}{section}

\newcommand{\TheTitle}{Dynamic Balanced Graph Partitioning} 
\newcommand{\TheAuthors}{M.~Bienkowski, C.~Avin, A.~Loukas, M.~Pacut, and S.~Schmid}
...
\author{
  Chen~Avin\thanks{Ben Gurion University of the Negev, Israel}
  \and
  Marcin~Bienkowski\thanks{University of Wroclaw, Poland}
  \and
  Andreas~Loukas\thanks{EPFL, Switzerland}
  \and
  Maciej~Pacut\footnotemark[3]
  \and
  Stefan~Schmid\thanks{University of Vienna, Austria}
}
...
\newcommand{\stefan}[1]{\textcolor{red}{(Stefan: #1)}}
