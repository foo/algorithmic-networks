...
\usepackage[margin=0.9in,bottom=1.2in]{geometry}
...
\renewcommand\Authfont{\fontsize{13.5}{15}\selectfont}
...
\hypersetup{
  ...
  pdfauthor={Chen Avin, Marcin Bienkowski, Andreas Loukas, Maciej Pacut, Stefan Schmid}
}
\fi
