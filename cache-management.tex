\todo{removed sections: introduction (whole), application: minimizing fwd tables, acknowledgements}

\section{INTRO (TODO RENAME)}
...
Y$. \lref[Invariant]{item:prop2} and the definition of \ALGTC implies $\cnt_t(Y) =
...
\todo{Is the separation of the proof of the lemma clear enough? Is ``In the following'' clear?}
