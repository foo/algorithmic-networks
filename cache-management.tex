...
fetches and evictions). In Section~\ref{sec:bisimulation}, we will show that such penalties can be easily simulated in our model.


The forwarding table consists of rules that might be nested, and hence their structure is hierarchical.
...
\todo{other problems }
However, this might result in the situation, where the router does not have sufficient information to proceed (we will show how to deal with this).
%
...
The described approach is implementable: one could simply add
