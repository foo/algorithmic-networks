...
In Chapter~\ref{ch:static-mapping}, we considered the static mapping, where nodes of virtual network reside at designated computational clusters until the computation task is done.
